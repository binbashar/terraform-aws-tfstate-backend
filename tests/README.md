...
docker run --rm -v /home/delivery/Binbash/repos/BB-Leverage/terraform/terraform-aws-tfstate-backend:"/go/src/project/":rw -v ~/.ssh:/root/.ssh -v ~/.gitconfig:/etc/gitconfig --entrypoint=dep -it binbash/terraform-resources:0.12.3 init
  ...
  Locking in master (fae7ac5) for transitive dep golang.org/x/sys
...
docker run --rm -v /home/delivery/Binbash/repos/BB-Leverage/terraform/terraform-aws-tfstate-backend:"/go/src/project/":rw -v ~/.ssh:/root/.ssh -v ~/.gitconfig:/etc/gitconfig --entrypoint=dep -it binbash/terraform-resources:0.12.3 ensure
...
```
TestBucketAndTableExist 2019-07-14T17:41:20Z command.go:158:
TestBucketAndTableExist 2019-07-14T17:41:20Z command.go:158: Destroy complete! Resources: 3 destroyed.
PASS
ok      project/tests   156.086s
sudo chown -R delivery:delivery .
```